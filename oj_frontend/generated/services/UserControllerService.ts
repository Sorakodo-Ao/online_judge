...
import type { BaseResponse_List_PersonalQuestionVO_ } from "../models/BaseResponse_List_PersonalQuestionVO_";
...
export class UserControllerService {
  ...
  /**
   * getPersonalQuestionVO
   * @param userId userId
   * @returns BaseResponse_List_PersonalQuestionVO_ OK
   * @throws ApiError
   */
  public static getPersonalQuestionVoUsingGet(
    userId?: number
  ): CancelablePromise<BaseResponse_List_PersonalQuestionVO_> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/user/personalQuestion",
      query: {
        userId: userId,
      },
      errors: {
